...
if __name__ == "__main__":
  with open('./sue_data_2.0/json_data/individual_files_archive/combined_vulnerabilities_data_file.json') as detected_vulnerabilities_file:
  ...
  with open('./sue_data_2.0/json_data/individual_files_archive/node_criticality_mapping_file.json') as node_criticality_mapping_file:
