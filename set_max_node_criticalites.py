...
if __name__ == "__main__":
  with open('./sue_data_2.0/json_data/detected_vulnerabilities.json') as detected_vulnerabilities_file:
    combined_vulnerabilities_data = json.load(detected_vulnerabilities_file)
  critical_functions_definitions_location = './sue_data_2.0/json_data/critical_functions_definition.json'
  critical_functions_mapping_location = './sue_data_2.0/json_data/critical_functions_mapping.json'
